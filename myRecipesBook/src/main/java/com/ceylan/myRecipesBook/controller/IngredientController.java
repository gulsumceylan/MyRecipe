...
public class IngredientController {
    ...
    @PostMapping("/update")
    public ResponseEntity update(@RequestBody UpdateIngredientRequest request) {
    ...
    public ResponseEntity<List<IngredientDto>> getRecipesByCategoryId(int recipeId) {
        return new ResponseEntity<>(ingredientManager.getIngredientsByRecipeId(recipeId), HttpStatus.OK);
    }
